  ...
  INSERT INTO `artigos` (`ID`, `Titulo`, `Autor`, `Data_Publicacao`, `img-previw`, `artigo-caminho`, `ID_Tag`) VALUES
  (26, 'Tecnicas de estudos', 'euzinho', '2023-10-12 18:51:37', '65286a690303e.jpg', '65286a6903040.pdf', NULL);
  ...
  INSERT INTO `artigo_pasta` (`id`, `id_pasta`, `id_artigo`) VALUES
  (22, 38, 26);
  ...
  INSERT INTO `pastas` (`id`, `nome_pasta`, `descricao`) VALUES
  (38, 'root', 'pasta pincipal'),
  (39, 'Estudos', '');
  ...
  INSERT INTO `pasta_user` (`id`, `id_user`, `id_pasta`) VALUES
  (16, 24, 38),
  (17, 24, 39);
  ...
  INSERT INTO `usuarios` (`ID`, `Nome_Usuario`, `Senha`, `Nome_Completo`, `Email`, `Data_Nasc`, `telefone`, `img-perfil`, `permissoes`) VALUES
  (24, 'Goulart', '$2y$10$MRMkbqznOSj0zSDgbk3FH.QbMojv1K67DlXuw.BLeL7NdkZwyZx82', 'Vinícius De Araujo Goulart', 'vinil115zv@gmail.com', '2006-04-18', NULL, NULL, NULL);
  ...
  ALTER TABLE `artigo_pasta`
    ...
    ADD CONSTRAINT `fk_artigos_artigo_pasta` FOREIGN KEY (`id_artigo`) REFERENCES `artigos` (`ID`) ON DELETE CASCADE;
