                ...
                <div class="col  mx-5" id="content">
                    <div class="row my-4" id="head">
                        ...
                        <div class="col" id="head-right">
                            ...
                            <div class="dropdown">
                                <button class="btn button dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                    Adicionar Artigos
                                </button>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                           data-bs-target="#adicionar-artigo">Adicionar artigo</a></li>
                                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                           data-bs-target="#adicionar-pasta">Adicionar pasta</a></li>
                            ...
                            <?php if (!isset($_SESSION['id_pasta'])) { ?>
                                <div class="row">
                                    <div class="grupo-conteudo my-2">
                                        ...
                                        <a data-bs-toggle="collapse" data-bs-target="#pastas" aria-expanded="false"
                                           aria-controls="pastas">
                                            <div class="btn-alternar">
                                                <svg class="icone-alternar bi bi-arrow-down-short"
                                                     xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem"
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="grupo-conteudo my-2">
                                    ...
                                    <a data-bs-toggle="collapse" data-bs-target="#artigos" aria-expanded="false"
                                       aria-controls="artigos">
                                        <div class="btn-alternar">
                                            <svg class="icone-alternar bi bi-arrow-down-short"
                                                 xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem"
                                                 fill="currentColor" viewBox="0 0 16 16">
