    ...
    function processarRequisicao(): void
    {
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
                <a class="navbar-brand" href="#">
                    <img src="/img/logos/logo_dark.png" alt="Logo" width="200rem"
                ...
                <div class="container col-10" id="popup_content">
                    ...
                    <div class="row">
                        ...
                        <form class="col-10" action="/login" method="post">
                            ...
                            <div class="mb-3">
                                <label for="email_log" class="form-label">Email </label>
                                <input id="email_log" type="email" class="form-control" name="email_log"
                                       aria-describedby="emailHelp">

                            </div>

                            <div class="mb-3">
                                <label for="senha_log" class="form-label">Senha</label>
                                <input id="senha_log" type="password" class="form-control" name="senha_log">
                            </div>

                            <div class="row">
                                <div class="col-2"></div>
                                <button type="submit" id="enviar_log" class="col-8 btn button btn-primary">Login
                                </button>
                                <div class="col-2"></div>
                            </div>
                ...
                <div class="container col-10" id="popup_content">
                    ...
                    <div class="row">
                        ...
                        <form class="col-10" action="/cadastrar" method="post">
                            ...
                            <div class="mb-3">
                                <label for="nasc_cad" class="form-label">Data de Nacimento</label>
                                <input id="nasc_cad" type="date" name="nasc_cad" value="2023-08-" max="2008-08-16"
                                       required>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-2"></div>
                                <button type="submit" id="enviar_cad" class="col-8 btn button btn-primary">Cadastrar
                                </button>
                                <div class="col-2"></div>
                            </div>
                        </form>
        ...
        <section class="container-fluid d-flex" id="banner2">
            <div class="container d-flex" id="banner2_textos">
                ...
                <p class="row lead b2-font-h2 text-justify">Com ArtOrganizer, os usuários podem facilmente compartilhar
                    seus
                    conhecimentos e perspectivas com a comunidade de entusiastas de artigos. Adicionar um novo artigo é
                    simples: basta inserir um título, conteúdo e tags relacionadas. Compartilhe seu conhecimento hoje
                    mesmo!
                </p>
            </div>
        </section>
        ...
        <section class="banners container-fluid d-flex justify-content-center" id="banner4">
            <div class="container d-flex  cartao justify-content-center">
                ...
                <div class="container-fluid col-md-8" id="banner4_textos">
                    ...
                    <h1 class="row justify-content-center b2-font-h1 text-center mb-5" id="banner4_titulo">
                        Compartilhamento
                        de Artigos</h1>
