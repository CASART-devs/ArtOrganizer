...
use mysqli;
    ...
    class ArtigoRepository{
        ...
        $query->bind_param("ssssi", $artigo->getTitulo(), $artigo->getArtigo(), $artigo->getImg(), $artigo->getArtigo(), $artigo->getId());
        $query->execute();
