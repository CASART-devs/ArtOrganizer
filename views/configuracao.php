                                    ...
                                    <div class="col">
                                        <div class="row d-flex justify-content-start">
                                            ...
                                            <div class="col mb-3 mr-3">
                                                ...
                                                <input type="text" class="form-control" name="nome" id=""
                                                       ...
                                                       placeholder="<?= $_SESSION['user_nome']; ?>" required>
                                            ...
                                            <div class="col  mb-3 mr-3">
                                                ...
                                                <input type="text" class="form-control" name="nick" id=""
                                                       aria-describedby="helpId"
                                                       placeholder="<?= $_SESSION['user_nick']; ?>" required>
                                                <small id="helpId" class="form-text text-muted">Digite seu
                                                    nickname</small>
                                            </div>
                                        ...
                                        <div class="row d-flex justify-content-start">
                                            ...
                                            <div class="col mb-3 mr-3">
                                                ...
                                                <input type="email" class="form-control" name="email" id=""
                                                       ...
                                                       placeholder="<?= $_SESSION['user_email']; ?>" required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col  mb-3 mr-3">
                                                    ...
                                                    <input type="text" class="form-control" name="telefone"
                                                           id="" aria-describedby="helpId" placeholder="<?php
                                        ...
                                        <div class="row d-flex justify-content-start">
                                            ...
                                            <div class="col d-grid gap-2 m-2">
                                                <button type="submit" name="" id="" class="button btn">
                                                    Atualizar
                                                </button>
                                            </div>
                                            <div class=" col d-grid gap-2 m-2">
                                                <button type="button" name="" id="" class="button btn ">
                                                    Cancelar
                                                </button>
                                            </div>
                                        </div>
